...
public class MailMsgSend {
    ...
    public static void main(String[] args) throws IOException {
        ...
        MailMsgBean message = new MailMsgBean();
        ...
        MailMsgSend smtp = new MailMsgSend(server, 465);
        boolean flag;
    ...
    public MailMsgSend(String server, int port) throws UnknownHostException,
            IOException {
        try {
    ...
    public void authLogin(MailMsgBean message, BufferedReader in,
    ...
    // 发送邮件主程序
    public boolean sendMail(MailMsgBean message, String server) {
        try {
