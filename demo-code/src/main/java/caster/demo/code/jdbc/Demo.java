...
public class Demo {
	...
	public void t1() throws Exception{
		DbConf dataSource = new C3p0Conf(
				"jdbc:mysql://127.0.0.1/demo?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull",
				"root",
				"root");
		dataSource.init();
	...
	private static void showPoolInfo(ComboPooledDataSource pool) {
        ...
        if(null != pds){
            try {
                ...
                System.out.println("c3p0 连接池中 【 总共 】 连接数量："+pds.getNumConnectionsDefaultUser());
