...
public class TimeUtils {
    ...
    public static boolean equal(Date d1, Date d2) {
        return d1 == null ? d2 == null : d2 != null && (d1 == d2 || StrUtils.equals(format(d1), format(d2)));
    }
    ...
    public static String format(Integer timestamp) {
        return new SimpleDateFormat(DEFAULT_TIME_PATTERN).format(new Date(timestamp * 1000L));
    }
